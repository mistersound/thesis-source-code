 ...
 //console.log(this.name_prefix.toUri());
  ...
  //Client doesn't have to respond to heartbeat Interest
    ...
    if (interestName.includes("stop")) {
       ...
       console.log("computation process is over; retrieve output");
	var words = this.prefix.split('/');
	
 	 var output = "/" + words[3] + "/" + words[4] + "/" + words[5] + "/" + words[6] + "/output" ;
	 //console.log(output);
	
	
	var exec = require('child_process').exec, child;
	
		var cmd = "ndncatchunks " + output + " > resultat.txt" ;
...
function initiate()
{
 ...
 var stop = "/" + words[3] + "/" + words[4] + "/" + words[6] + "/" + words[6] + "/stop"; 

 var dPrefix = stop;//"/lacl/data/0/9/stop"; //"/upec/test";
