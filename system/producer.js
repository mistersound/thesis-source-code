...
var Producer = function(prefix, face, keyChain, certificateName)
{
  ...
  this.name_prefix = (new Name(prefix));//.append("testApp").append();
    ...
    face.registerPrefix(this.name_prefix, this.onInterest.bind(this), this.onRegisterFailed.bind(this), this.onRegisterSuccess.bind(this));
    //face.setInterestFilter(this.prefix, this.onInterest.bind(this));
};



Producer.prototype.onRegisterSuccess = function(prefix) 
{
  console.log("Prefix registration succeeded for: " + prefix);

};

Producer.prototype.onRegisterFailed = function(prefix)
{
  console.log("Prefix registration failed for: " + prefix);
};



Producer.prototype.onData = function(interest, data) 
{
...
Producer.prototype.onTimeout = function(interest) 
{
 ...
 Producer.prototype.onInterest = function(prefix, interest, face, interestFilterId, filter)
{
  console.log("Interest received for: " + interest.getName().toUri());
  ...
  if (content != null) {
   ...
   console.log("Send data for: " + interest.getName().toUri());
...
function initiate()
{
  ...
  var producer = new Producer(prefix, face, keyChain,
